...
2. Connected to ThingSpeak cloud to get live data

3. Displayed temperature, humidity, soil moisture, and water level
   
4. Implemented automatic refresh every 5 seconds
